<template>
  <div class="categories">
    ...
    <div class="info">
      ...
      <div class="categories-content" v-loading="articleLoading">
        <ListItem
          :info="item"
...
export default defineComponent({
  ...
  setup() {
    ...
    const categoriesList = computed(() => store.state.userInfo.category);
    const userInfo = computed(() => store.state.userInfo);
    const init = () => {
      const currentId: any = route.query.id;
      categoriesList.value.map((item: any, index: any) => {
    ...
    const getArticleByCategoryId = async () => {
      const params = {
        id: state.id,
        page: state.page,
      ...
      const data: any = await api.getArticleByCategoryId(params);
